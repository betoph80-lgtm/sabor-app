...
export const CajaView: React.FC = () => {
  const { currentUser, orders, payOrder, products, customers, updateWholeOrder, currentMenu, mesas, selectedDate, cashControls } = useApp();
  ...
  // Account settlement/liquidation modal states
  ...
  return (
    <div className="p-2 md:p-6 space-y-6 md:space-y-8 max-w-7xl mx-auto">
